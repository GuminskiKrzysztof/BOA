...
namespace BOA
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //            OptimizationResult opt = TestsFunctions.FindBest(myFuncion: TestsFunctions.Rastrigin, dim_in: d, iterations_in: i, range_in: range, population_size_in: n,
            //                            a_list: a_list, c_list: c_list, p_list: p_list, "Rastrigin", 200);
            //            opt.SaveToCsv("csv1.csv");
            ...
            Butterfly but = new Butterfly(myFuncion: TestsFunctions.Rosenbrock, dim_in: 5, iterations_in: 50, range_in: range, population_size_in: 50,
                                        a_in: 0.1, c_in: 0.7, p_in: 0.7);
            but.Solve();
